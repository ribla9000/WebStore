...
class Order(models.Model):
	...
	# c_ount = models.IntegerField(default=1, name='Count')
	
	
	comments = models.TextField(blank=True, null=True, default=None)
	

	customer_adress = models.CharField(max_length=250, blank=True, null=True, default=None)
	...
	def save(self, *args, **kwargs):
		...
		# self.total_price=self.c_ount * price_per_item
